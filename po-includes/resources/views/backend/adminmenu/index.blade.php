...
@section('content')
	<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-20">
		...
		<div><a href="{{ url('dashboard/admin-menu/table') }}" class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-t-10"><i data-feather="grid" class="wd-10 mg-r-5"></i> {{ __('menumanager.table') }}</a></div>
	</div>
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div>
						...
						<div class="dd" id="nestable">
							<ol class="dd-list">
								@if(count($menu) > 0)
									@each('backend.adminmenu.menu', $menu, 'menu', 'backend.adminmenu.menu')
								@endif
							</ol>
						</div>
					</div>
				...
				<div class="col-md-4">
					...
					<div class="card mg-t-20">
						...
						{!! Form::open(['url' => '/dashboard/admin-menu', 'class' => 'form-horizontal']) !!}
							<div class="card-body pd-b-0">
								...
								@include ('backend.adminmenu.form', ['formMode' => 'create'])
							</div>
...
<script type="text/javascript">
	$(function() {
		...
		$('.dd').on('change', function() {
			...
			$.ajax({
				type: 'POST',
				url: '{{ url("dashboard/admin-menu/menusort") }}',
				data: dataString,
				cache : false,
