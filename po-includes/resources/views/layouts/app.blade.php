...
<head>
	...
	<link href="{{ asset('/po-admin/assets/menu/style.css')}}" rel="stylesheet">
...
<body>
	<aside class="aside aside-fixed">
        ...
        <div class="aside-body">
			...
			@each(adminBase('adminmenu.menus'), getAdminMenu(), 'menu', adminBase('adminmenu.menus'))	
			</ul>
		</div>
    </aside>
	...
	<script type="text/javascript" src="{{asset('po-admin/assets/menu/scripts.js')}}"></script>
	<script type="text/javascript" src="{{asset('po-admin/assets/menu/scripts2.js')}}"></script>
	<script type="text/javascript" src="{{asset('po-admin/assets/menu/menu.js')}}"></script>
	@stack('scripts')
